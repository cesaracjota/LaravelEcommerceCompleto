...
class CartComponent extends Component
{
    ...
    {
        Cart::instance('saveForLater')->remove($rowId);
        session()->flash('s_success_message', 'Se ha eliminado el elemento de guardar para más tarde');
    }
    ...
    public function applyCouponCode()
    {
        ...
        if(!$coupon)
        {
            session()->flash('coupon_message','¡El código de cupón no es válido!');
            return;
        }
    ...
    public function calculateDiscounts()
    {
        ...
        {
            if(session()->get('coupon')['type'] == 'fijo')
            {
    ...
    public function render()
    {
        ...
        return view('livewire.cart-component',['sproducts'=>$sproducts, 'sale'=>$sale,'popular_products'=>$popular_products])->layout('layouts.base');
    }
}
