							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item wrap-gallery">
										<div class="col-md-4">
											<img src="{{ asset('assets/images/iconos/card.png') }}" width="80" alt=""/>
										</div>
										<div class="col-md-4">
											<img src="{{ asset('assets/images/iconos/card.png') }}" width="80" alt=""/>
										</div>
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="{{$setting->telegram}}" class="link-to-item" title="telegram"><i class="fa fa-telegram" aria-hidden="true"></i></a></li>
											<li><a href="{{$setting->instagram}}" class="link-to-item" title="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
											<li><a href="{{$setting->whatsapp}}" class="link-to-item" title="whatsapp"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2021 Acjota. All rights reserved</p>
					</div>
